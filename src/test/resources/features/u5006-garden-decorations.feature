Feature: As Liam, I want to be able to add decorations such as fountains and gnomes to my gardens.
  ...
  Scenario: AC3 - Given I have placed a decoration and saved it, when I view the garden in 3D, then I can see it in the garden.
    Given There is a garden decoration "fountain" saved in my "oliver@email.com" garden "oliver's Garden"
    When I "oliver@email.com" open the 3D view of my garden "oliver's Garden"
    Then I can see the garden decoration "fountain" in my "oliver@email.com" garden "oliver's Garden"