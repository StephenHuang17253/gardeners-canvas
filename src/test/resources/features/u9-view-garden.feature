 Feature: U9 As Kaia, I want to see information about my garden so that I can keep the details accurate
   Background:
     Given "Kaia" "Pene", 67 is a user with email "kaia123@email.com" and password "TestPassword10!"
     And User "kaia123@email.com" has a garden "Kaia's Garden" located in "Christchurch", "New Zealand"
     ...
     And I as user "kaia123@email.com" am logged in with "TestPassword10!"

   Scenario: AC1 - A logged in user can view gardens which they own
     When I try to visit user "kaia123@email.com"'s garden, "Kaia's Garden"
