...
//    AC4.1, AC.4.3
    ...
    public void i_submit_create_new_plant_form() throws Exception {
        MockMultipartFile mockFile = new MockMultipartFile("profilePictureInput", "test.jpg",
                "image/jpg", "Not Actually a picture".getBytes());
    mvcResult = mockMvc.perform(
                        MockMvcRequestBuilders
                                .multipart("/my-gardens/{gardenId}/create-new-plant", garden.getGardenId())
                                .param("plantPictureInput", String.valueOf(mockFile))
...
//    AC4.1
    ...
    public void my_plant_is_created_with_the_plant_category(String plantName, String plantCategory) {
        ...
        Assertions.assertEquals(plantName, model.get("plantName"));
        Assertions.assertEquals(plantCategory, model.get("plantCategory"));
    }
// AC4.2
...
//    AC4.2
    ...
    public void my_plant_is_updated_with_the_plant_category(String plantName, String newPlantCategory) throws UnsupportedEncodingException {
