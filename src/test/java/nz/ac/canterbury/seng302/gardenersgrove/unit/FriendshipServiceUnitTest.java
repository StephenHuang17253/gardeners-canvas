...
public class FriendshipServiceUnitTest {
    ...
    void before() {
        ...
        testUser1 = Mockito.spy(new User("John", "Doe", "jhonDoe@ManageFriendsControllerIntegrationTest.com",
                LocalDate.of(2003, 5, 2)));
        testUser2 = Mockito.spy(new User("Walter", "Doe", "pending@ManageFriendsControllerIntegrationTest.com",
                LocalDate.of(2003, 5, 2)));
    ...
    void checkFriendshipExists_friendship1to2Exists_returnTrue() {
        ...
        Mockito.when(friendshipRepository.findByUser1IdAndUser2Id(testUser1.getId(), testUser2.getId()))
                .thenReturn(mockOptionalFriendship);
        Mockito.when(friendshipRepository.findByUser1IdAndUser2Id(testUser2.getId(), testUser1.getId()))
    ...
    void updateFriendshipStatus_toValidValue_StatusChanged() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            friendshipService.updateFriendShipStatus(1L, FriendshipStatus.ACCEPTED);
        });
    }
