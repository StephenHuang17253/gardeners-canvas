...
class PlantFormControllerTest {
    ...
    User mockUser2 = new User("Test2", "Test", "differentEmail@gmail.com", LocalDate.now());
    Garden testGarden;
    Garden anotherGarden;
    Garden anotherGarden2;
    ...
    void before_or_after_all() {
        ...
        userService.addUser(mockUser2, "1es1P@ssword");
        ...
        anotherGarden2 = gardenService.addGarden(new Garden(
                "anotherGarden",
                "test",
                "test",
                "test",
    ...
    void confirmImportPlant_validInput_returnForm() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/import-plant/confirm").
                        param("gardenId", String.valueOf(String.valueOf(testGarden.getGardenId())))
                        .param("plantId", String.valueOf(1L))
                        .param("gardenIdOfOriginalPlant", String.valueOf(anotherGarden.getGardenId())))
                .andExpect(status().isOk());
    }
    ...
    @Test
    @WithMockUser(username = "test@gmail.com")
    void confirmImportPlant_invalidGarden_returns404() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/import-plant/confirm").
                        param("gardenId", String.valueOf(0L))
                        .param("plantId", String.valueOf(1L))
                        .param("gardenIdOfOriginalPlant", String.valueOf(anotherGarden.getGardenId())))
    ...
    @Test
    @WithMockUser(username = "differentEmail@gmail.com")
    void confirmImportPlant_isNotGardenOwner_returns403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/import-plant/confirm").
    ...
    void plantFormController_editCountVariantsPass(String plantCount) throws Exception {
        ...
        Assertions.assertEquals((int) Double.parseDouble(plantCount.replace(',', '.')),
                actualPlant.getPlantCount());
