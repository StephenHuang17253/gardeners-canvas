...
const handleEmailUpdate = (event) => {
    ...
    if (emailValue.length > MAX_EMAIL_LENGTH || localPart.length > 64 || domainPart.length > 255) {
        emailJSError.textContent = "Email is too long, should be 320 characters or less. The local part should be max 64 characters and domain should be max 255 characters";
        displayEmailError();
