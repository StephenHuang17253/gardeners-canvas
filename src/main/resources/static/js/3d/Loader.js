...
class Loader {
    ...
    constructor() {
         ...
         */
        this.setOnLoad = (callback) => this.manager.onLoad = callback;
         ...
         */
        this.setOnError = (callback) => this.manager.onError = callback;
         ...
         */
        this.loadTexture = (path) => this.textureLoader.load(path);
         ...
         */
        this.loadModel = async (path, name) => {
         ...
         */
        this.loadBackground = (path, onLoad) => {
            this.exrLoader.load(
                path,
                texture => {
