 ...
 */
const handleClearAllButtonClicked = () => {
...
/**
 * Handles resizing the stage when the window is resized
 */
...
/**
 * Handles clicks on the window, main use is deselecting plant in palette when clicking outside of the palette
 *
 * @param {Event} event - The event object
 */
const handleWindowClicked = (event) => {

    // If there is no highlighted palette item, return
    if (!highlightedPaletteItem) return;
    ...
    if (!highlightedPaletteItem.contains(event.target)) {
        highlightedPaletteItem.style.border = "none";
        highlightedPaletteItem = null;
        selectedPlantInfo = null;
    }
